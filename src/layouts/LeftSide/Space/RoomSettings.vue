<template>
  <div class="row q-pa-sm q-pl-md">
    <q-input input-class="mps-input-class" dense v-model.number="roomWidth" @update:modelValue="setRoom" :suffix="unitLabel" :title="`${roomWidth}${unitLabel}`" type="number" step="1" style="width: 100%">
    ...
    <q-input input-class="mps-input-class" v-model.number="roomHeight" @update:modelValue="setRoom" :suffix="unitLabel" :title="`${roomHeight}${unitLabel}`" dense type="number" step="1" style="width: 100%">
      <template v-slot:prepend>
        <div class="text-subtitle2" style="width:60px">
          {{$t('height')}}:
        </div>
    ...
    <q-input input-class="mps-input-class" v-model.number="roomDepth" @update:modelValue="setRoom" :title="`${roomDepth}${unitLabel}`" type="number" step="1" dense :suffix="unitLabel" style="width: 100%">
      <template v-slot:prepend>
        <div class="text-subtitle2" style="width:60px">
          {{$t('depth')}}:
        </div>
